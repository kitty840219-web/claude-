...
export default function BottomNav() {
  ...
  return (
    <nav
      aria-label="主要導覽"
      className="fixed inset-x-0 bottom-0 z-40 border-t border-night/10 bg-paper/95 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_24px_-12px_rgba(43,42,92,0.25)] backdrop-blur md:hidden"
    >
