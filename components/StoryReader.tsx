    ...
    <div>
      ...
      <div className="mx-auto mt-10 max-w-2xl px-4 sm:px-6">
        <div
          ...
          className={`bg-grain group relative cursor-pointer overflow-hidden rounded-[1.75rem] border border-gold/20 bg-gradient-to-br ${palette} p-6 shadow-soft transition hover:border-gold/40 sm:p-9`}
        >
